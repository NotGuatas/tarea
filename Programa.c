...
int main()
{
    ...
    {
    case 'a':
        printf("Ingrese la cantidad en unidades de llantas \n");
        scanf("%f",&cantidad1);

        break;
    case 'b':
        printf("Ingrese la cantidad en unidades de Pastillas de freno \n");
        scanf("%f",&cantidad2);
        break;
    case 'c':
        printf("Ingrese la cantidad en unidades de Kit de embrague \n");
        scanf("%f",&cantidad3);
    
        break;
    case 'd':
        printf("Ingrese la cantidad en unidades de Faro \n");
        scanf("%f",&cantidad4);
    
        break;
    case 'e':
        printf("Ingrese la cantidad en unidades de Radiador \n");
        scanf("%f",&cantidad5);
